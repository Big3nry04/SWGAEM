...
export default function LayoutVentas() {
  ...
  const tabs = [
    { to: "/ventas", label: "Listado de Ventas", icon: ListChecks, end: true },
    { to: "/ventas/nueva", label: "Nueva Venta", icon: FilePlus2 },
    { to: "/ventas/historial", label: "Historial", icon: Clock3 },
    { to: "/ventas/comprobante", label: "Generar Comprobante", icon: FileText },
  ];
